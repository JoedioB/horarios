...
exports.isSlotValidoParaDia = exports.DIAS_SEMANA = exports.SLOTS_PARES = exports.SLOTS = void 0;
exports.SLOTS = [
...
exports.SLOTS_PARES = [
    { slot1: exports.SLOTS[0], slot2: exports.SLOTS[1] },
    { slot1: exports.SLOTS[2], slot2: exports.SLOTS[3] },
    { slot1: exports.SLOTS[5], slot2: exports.SLOTS[6] },
    { slot1: exports.SLOTS[8], slot2: exports.SLOTS[9] },
];
exports.DIAS_SEMANA = ['Segunda', 'Terça', 'Quarta', 'Quinta', 'Sexta'];
/**
...
const isSlotValidoParaDia = (dia, horaInicio) => {
    const slot = exports.SLOTS.find(s => s.inicio === horaInicio);
    if (!slot)
        return false;
...
exports.isSlotValidoParaDia = isSlotValidoParaDia;
